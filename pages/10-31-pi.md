...
`19 × 99` and `199 × 99` are both less than `199^2` and hence less than `199^9`; `9^9 < 199^9`; `1^999 = 1`.
:::
...
* [ ] Same as the Moon
* [ ] Same as the Earth
* [ ] Five times more than the Sun
* [x] Ten times more than a supermassive black hole   
...
__5.1__ When exactly is the value of the produce `(1 + 1/2)(1 + 1/3)(1 + 1/4) ... (1 + 1/n)` equal to an integer?
