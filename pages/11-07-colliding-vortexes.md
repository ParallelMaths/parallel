...
__2.1__ Which of the following is the best estimate for the number of seconds in a year?
...
__5.1__ What is the smallest number of this type (lots of 3s ending with a 1) which is not prime?
...
__6.1__ A 4 by 4 'antimagic square' is an arrangement of the numbers 1 to 16 inclusive in a square, so that the totals of each of the four rows and four columns and two main diagonals are ten consecutive numbers in some order.  
...
__8.1__ Follow the same procedure in the video, starting with the number 462. What is your answer?

<input solution="1089"/>
:::

::: problem id=8_2 marks=2
__8.2__ Follow the same procedure in the video, starting with the number 464. The trick will not work because the number is a palindrome (i.e., the same backwards). What is your answer when you start with 464?
