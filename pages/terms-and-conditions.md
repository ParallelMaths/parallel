...
*	Name
*	Email address
*	Approximate age (in order to assign a Level)
*	Identifying code to link students to their teachers (optional)

Students who take part in the Parallel Circles webinar series may also be asked to optionally provide:
*	Optional alternative email address
*	Parent/guardian email
*	Month of Birth and Year of Birth (so that we can assign a level accurately)
*	Gender
*	Ethnicity
*	Country
*	For students who are based in England, Pupil Premium status (as we may have additional free services and support we can offer to Pupil Premium students)
*	School name
*	Email address for a school contact (eg teacher)
...
All of our users' passwords are hashed, and all user data is encrypted and stored securely on Google Cloud servers. You can find more technical details here: https://firebase.google.com/support/privacy.
...
All individuals have the right to access personal information that is held about them. If you wish to make such a request, please contact the Data Protection Officer at [contact@parallel.org.uk](mailto:contact@parallel.org.uk), who will also act as the contact point for any requests under the Privacy Policy.


## How we use personal information
Requests for data are made directly to the individual involved, or to their parent/guardian. Data is confirmed with the individual’s school where appropriate. Some data will be provided by schools who nominate their students for the Maths Masterclass program – but only after the school has gathered the consent of their student. Only data that is relevant and necessary will be collected.
...
5.	Enabling users to take part in Parallel Circles webinars;
6.	Alerting users and/or their parents/guardians to the scheduling of Parallel Circles webinars and how to gain access;
7.	Tracking Parallel Circles attendances and engagement in order to award students with points and badges;
8.	Monitoring the diversity of Parallel Circles webinar users, and planning measures to enable wider participation;
9.	Alerting teachers to Parallel features and enrichment offers;
10.	Contacting winners of sporadic competitions.
...
__Date: November 2022__

* [Downloadable this Data Protection & Terms and Conditions policy](/resources/parallel-updated-data-policy-202211.pdf){target="_blank"}
