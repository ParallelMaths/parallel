...
`5/6 – 2/3` as a single fraction in its simplest form (use / when writing fractions)
...
<input solution="10.68"/>  
:::


## 22.
::: problem id=22_1 marks=1
Number of minutes in 11.5 hours
...
`2/5` of `25/32` as a fraction in its simplest form (use / when writing fractions)
