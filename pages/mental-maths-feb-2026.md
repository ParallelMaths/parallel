...
`8/10 – 1/5` as a single fraction in its simplest form (use / when writing fractions)
...
<input solution="20.68"/>  
:::


## 22.
::: problem id=22_1 marks=1
Number of minutes in 11.25 hours
...
`2/7` of `28/32` as a fraction in its simplest form (use / when writing fractions)
