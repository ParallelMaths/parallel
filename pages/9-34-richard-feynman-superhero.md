...
@[youtube](ZbFM3rn4ldo?rel=0) _(If you have any problems watching the video then just right click and open it in a new window)_
...
__1.2__ Take a look at Richard Feynman’s Wikipedia page or any page that tells you about his life. Which project did Feynman work on when he was young man?
...
__2.1__ A sector of a disc is removed by making two straight cuts from the circumference to the centre. The perimeter of the sector has the same length as the circumference of the
original disc.  
...
__3.1__ How many 4-digit integers (from 1000 to 9999) have at least one digit repeated?
